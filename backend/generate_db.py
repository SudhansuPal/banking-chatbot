...
FAQS = [
    ...
    ("What are the branch hours?", "Most First National Bank branches are open Monday–Friday 9:00 AM to 5:00 PM, and Saturday 9:00 AM to 1:00 PM. Branches are closed on Sundays and federal holidays. Use our branch locator for specific location hours."),
    ("How do I set up direct deposit?", "To set up direct deposit, provide your employer with First National Bank's routing number (021000021) and your account number. You can find these on the bottom of your checks or in the 'Account Details' section of online banking."),
    ...
    ("What is the routing number?", "First National Bank's routing number is 021000021. This 9-digit number is used for ACH transfers, direct deposits, and wire transfers. You can also find it on the bottom left of your personal checks."),
    ("How do I transfer money between accounts?", "Log in to online banking, select 'Transfers' from the main menu, choose the source and destination accounts, enter the amount, and confirm the transfer. Transfers between First National Bank accounts are immediate and free."),
    ("What are the overdraft fees?", "First National Bank charges a $35 overdraft fee per transaction if your account balance goes negative. We offer Overdraft Protection — link a savings account or credit card to automatically cover shortfalls. You can opt in through online banking or at a branch."),
    ...
    ("How do I contact customer support?", "You can reach First National Bank customer support 24/7 at 1-800-555-0100, via live chat on our website or mobile app, or by emailing support@firstnationalbank.com. Branch support is available during business hours."),
    ("Is my money FDIC insured?", "Yes. First National Bank is a member of the FDIC. Your deposits are insured up to $250,000 per depositor, per ownership category. This includes checking accounts, savings accounts, CDs, and money market accounts."),
    ("How do I enroll in online banking?", "Visit firstnationalbank.com and click 'Enroll in Online Banking'. You'll need your account number, Social Security Number, and the email address associated with your account. You'll receive a verification code by email or SMS to complete enrollment."),
...
USERS = [
    ("admin",    "admin123",    "Admin User",      "admin@firstnational.com",    "admin"),
